/**
 * @FileName        obje.ts
 * @CreatedTime     一,  1 13, 2025 17:10
 * @LastModified    一,  1 13, 2025 17:10
 ...
 * 将 b 深度合并到 a
 */
export function simpleAssign<T extends Record<string, any>, U>(a: T, b: U, options: SimpleAssignOptions = {}, seen = new Set<unknown>()): T & U {
